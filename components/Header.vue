<template>
  <header>
    <div class="navbar__one">
      ...
      <div class="nav__sub__two">
        <button class="__upgrade">
          <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M9.83333 1.66669L1.5 11.6667H9L8.16667 18.3334L16.5 8.33335H9L9.83333 1.66669Z" stroke="#344054"
    ...
    <div class="navbar__two">
      ...
      <div class="nav__sub__four">
        <form>
          ...
          <input type="search" id="searc" placeholder="Search">
        </form>
      </div>
    </div>
  </header>
